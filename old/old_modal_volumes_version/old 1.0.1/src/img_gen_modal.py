...
def generate_image(prompt_alias, team_color, model_alias, custom_prompt, height=360, width=640, num_inference_steps=20, guidance_scale=2.0, seed=-1):
    ...
    try:
        ...
        return "default_image.png", "ERROR: Invalid prompt or model selected."
    ...
    try:
        ...
        return "default_image.png", f"ERROR: Failed to initialize InferenceClient. Details: {e}"
    ...
    try:
        ...
        return "default_image.png", f"ERROR: Failed to generate image. Details: {e}"
    print ("done")
    print(image)
    ...
    try:
        ...
        return "default_image.png", f"ERROR: Failed to save image. Details: {e}"
    # Return the filename and success message
    print(f"{output_filename}, Image generated successfully!")
    # Return the filename and success message
    return output_filename, "Image generated successfully!"

    # Display the saved image locally
    if output_filename:
